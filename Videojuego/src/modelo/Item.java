    ...
    public void aplicarA(Personaje jugador, Enemigo enemigo) {
        ...
        switch (this.efecto) {
            case CURAR_PORCENTAJE: // VAPER
                System.out.println("Necesitas un break. Le das una calada al vaper. Disfrutas el sabor de la guanábana. Recuperas un " + this.modificador + "% de tu salud");
                int cura = (jugador.getVidaMaxima() * this.modificador)/100;
                jugador.curar(cura);
                break;
                
            case DANIO_PORCENTAJE_ENEMIGO: // M.L.P.E
                System.out.println("Abres la mantequilla y le lanzas tropezones al enemigo. Inglinges un " + this.modificador + "% de daño de la vida del enemigo.");
            ...
            case DUPLICAR_DEFENSA: // GABARDINA DE SERGIO
                System.out.println("Te pones la gabardina de Sergio. Ahora si que no hay quien te pare. Duplica el valor de tu escudo.");
                jugador.aumentarDefensa(jugador.getDefensa());
                break;
            
            case ROBAR_VIDA: // EL CHATTO
                System.out.println("El Chatto le roba las ideas al enemigo. Le quitas al enemigo el " + this.modificador + "% de su vida y te la curas con ella");
                ...
                System.out.println("Te pones las Gafas de Soraya. Ves todo con más claridad, hasta los puntos débiles del enemigo.");
