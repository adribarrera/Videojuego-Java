...
public class Tienda {
    ...
    private void cargarMaquinaExpendedora() {
        ...
        inventarioTienda.add(new Item("Mantequilla L.P.E.",
                "Tu probabilidad de crítico aumenta de forma permanente un 40%.",
                "/assets/imagenes/Objetos/Normal/mantequilla.png", 40,
                TipoEfecto.AUMENTAR_CRITICO, 150));
        inventarioTienda.add(new Item("Gabardina de Sergio", "Aumenta permanentemente tu defensa en 30 puntos extra.",
